...
@Component({
  selector: 'qs-git-line-chart',
  templateUrl: './git-line-chart.component.html',
  encapsulation: ViewEncapsulation.None,
  styleUrls: ['./git-line-chart.component.scss']
})

export class GitLineChartComponent implements OnInit, OnChanges {
  initExecuted = false;
  title = 'app';
  sprints: JSON[];
  width;
  ...
  async load(): Promise<void> {
    try {
      ...
      this.sprints = await this.commitService.search(this.project._id, this.day);
    } finally {
